  ...
  return (
    <section id="experience" className="py-20 md:py-32">
      ...
      <div className="max-w-3xl mx-auto space-y-12 relative">
        {/* Timeline line */}
        <div className="absolute left-4 sm:left-5 top-0 bottom-0 w-px bg-gradient-to-b from-indigo-400/30 dark:from-indigo-500/50 via-cyan-400/20 dark:via-cyan-500/30 to-transparent" />
          ...
          <FadeIn key={index} delay={index * 150}>
            <div className="relative flex gap-4 sm:gap-8 group">
              ...
              <div className="relative z-10 flex-shrink-0">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-indigo-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-indigo-500/20 group-hover:shadow-indigo-500/40 group-hover:scale-110 transition-all duration-300">
              ...
              <div className="flex-grow glass p-6 rounded-2xl hover:border-indigo-500/20 transition-all duration-300 card-hover">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-3 gap-2">
                  ...
                  <span className="text-sm font-mono text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-500/10 px-3 py-1 rounded-full w-fit border border-indigo-200 dark:border-indigo-500/20">
                    {exp.duration}
                  </span>
                </div>
                ...
                <ul className="space-y-3">
                  {exp.description.map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-slate-600 dark:text-slate-300 text-sm leading-relaxed">
                      <ChevronRight size={16} className="text-indigo-500 dark:text-indigo-400 mt-0.5 flex-shrink-0" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
